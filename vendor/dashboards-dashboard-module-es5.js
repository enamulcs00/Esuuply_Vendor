  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboards-dashboard-module"], {
    ...
    function srcAppDashboardsDashboardComponentsInfoCardInfoCardComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      InfocardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 97,
        vars: 0,
        consts: [[1, "row"], [1, "col-md-3"], [1, "card"], [1, "card-body", "card-box", "p-2"], [1, "d-flex", "align-items-center"], [1, "m-r-10"], [1, "btn", "btn-circle", "btn-lg", "bg-primary"], [1, "sl-icon-people", "text-white"], [1, "ml-auto"], [1, "m-b-0", "font-light"], [1, "btn", "btn-circle", "btn-lg", "btn-primary"], [1, "fas", "fa-chart-line", "text-white"], [1, "fas", "fa-chart-bar", "text-white"], [1, "fab", "fa-first-order", "text-white"], [1, "fas", "fa-th", "text-white"], [1, "fas", "fa-percent", "text-white"], [1, "fas", "fa-users", "text-white"], [1, "fas", "fa-eye", "text-white"]],
    ...
    function srcAppDashboardsDashboardComponentsSalesSalesComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      SalesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 39,
        vars: 12,
        consts: [[1, "row"], [1, "col-md-6"], [1, "card"], [1, "card-body"], [1, "d-flex", "align-items-center"], [1, "btn-circle", "btn-lg", "btn", "btn-outline-secondary"], [1, "sl-icon-people"], [1, "m-l-10"], [1, "card-title"], [1, "ml-auto"], [1, "custom-select", "b-0"], ["selected", ""], ["value", "1"], ["baseChart", "", 3, "datasets", "labels", "options", "legend", "chartType", "colors", "chartHover", "chartClick"]],
